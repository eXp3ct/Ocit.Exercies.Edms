...
namespace Ocit.Exezrcies.Emds.Data.Migrations
{
    ...
    [Migration("20230817114047_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BasicDocumentDocumentKind", b =>
                {
                    b.Property<int>("BasicDocumentsId")
                        .HasColumnType("integer");

                    b.Property<int>("DocumentKindId")
                        .HasColumnType("integer");

                    b.HasKey("BasicDocumentsId", "DocumentKindId");

                    b.HasIndex("DocumentKindId");

                    b.ToTable("BasicDocumentDocumentKind");
                });
            ...
            modelBuilder.Entity("Ocit.Exercies.Emds.Domain.BasicDocument", b =>
                {
                    ...
                    b.Property<List<int>>("DocumentKindIds")
                        .IsRequired()
                        .HasColumnType("integer[]");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2023, 8, 17, 11, 40, 46, 985, DateTimeKind.Utc).AddTicks(6488),
                            Discriminator = new Guid("d27975a9-4b07-4883-b236-f4361245975b"),
                            DocumentKindIds = new List<int> { 1 },
                        ...
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2023, 8, 17, 11, 40, 46, 985, DateTimeKind.Utc).AddTicks(6518),
            ...
            modelBuilder.Entity("Ocit.Exercies.Emds.Domain.DocumentKind", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Ocit.Exercies.Emds.Domain.IncomingDocument", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 4,
                            CreatedDate = new DateTime(2023, 8, 17, 11, 40, 46, 985, DateTimeKind.Utc).AddTicks(6554),
                            Discriminator = new Guid("d27975a9-4b07-4883-b236-f4361245975b"),
                            DocumentKindIds = new List<int> { 2 },
                        ...
                        {
                            Id = 5,
                            CreatedDate = new DateTime(2023, 8, 17, 11, 40, 46, 985, DateTimeKind.Utc).AddTicks(6563),
                            Discriminator = new Guid("e4321c60-166c-4479-9eb7-b71768832fb3"),
                            DocumentKindIds = new List<int> { 2 },
                        ...
                        {
                            Id = 6,
                            CreatedDate = new DateTime(2023, 8, 17, 11, 40, 46, 985, DateTimeKind.Utc).AddTicks(6572),
                            Discriminator = new Guid("d27975a9-4b07-4883-b236-f4361245975b"),
                            DocumentKindIds = new List<int> { 2 },
            ...
            modelBuilder.Entity("BasicDocumentDocumentKind", b =>
                {
                    b.HasOne("Ocit.Exercies.Emds.Domain.BasicDocument", null)
                        .WithMany()
                        .HasForeignKey("BasicDocumentsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Ocit.Exercies.Emds.Domain.DocumentKind", null)
                        .WithMany()
